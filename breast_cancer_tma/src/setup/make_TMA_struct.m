...
TMA_struct =load('/home/alexandonian/heterogeneity/breast_cancer_tma/src/mat_files/StructData_CC_Pheno.mat');

%% Set path of the project's base directory
TMA_struct.base_path = '/home/alexandonian/heterogeneity/breast_cancer_tma/';
...
save([TMA_struct.base_path, 'src/mat_files/TMA_struct.mat'], 'TMA_struct');
