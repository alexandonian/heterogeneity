function [Patches] = process_pseudo_image(Im_info, tilesize, threshold)
...
outdir = ['~/heterogeneity/Breast_Cancer_TMA/proc_images/pseudo-colored/cohort_',...
...
for i = 1:nPatches
    ...
    if (detectCells(patch_info, tilesize) < threshold)
